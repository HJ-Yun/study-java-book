...
import org.zerock.RESTexample.domain.Reply;
...
import org.zerock.RESTexample.repository.ReplyRepository;
...
public class ReplyServiceImpl implements ReplyService{
    ...
    public ReplyDTO read(Long rno) {
        ...
        Optional<Reply> readOptional = replyRepository.findById(rno);

        Reply reply = readOptional.orElseThrow();
    ...
    public void modify(ReplyDTO replyDTO) {
        ...
        Optional<Reply> readOptional = replyRepository.findById(replyDTO.getRno());
    ...
    public void remove(Long rno) {
        //deleteById do not throw EmptyResultDataAccessException anymore.
