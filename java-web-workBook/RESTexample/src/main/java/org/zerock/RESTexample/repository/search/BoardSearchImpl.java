...
import org.zerock.RESTexample.domain.QBoard;
import org.zerock.RESTexample.domain.QReply;
import org.zerock.RESTexample.dto.BoardImageDTO;
...
public class BoardSearchImpl extends QuerydslRepositorySupport implements BoardSearch {
    ...
    public Page<Board> search1(Pageable pageable){
        ...
        booleanBuilder.or(board.content.contains("1")); // where content like...
        ...
        List<Board> list = query.fetch(); // run the sql

        long count = query.fetchCount(); // run the sql with count
